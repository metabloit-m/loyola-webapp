...
export default function Members({members, registerForm}) {
    ...
    return (
        <>
            <div id="top_members" className="min-h-screen p-2">
                {/*<div className={`${blur ? "blur-sm" : ""}`}></div>*/}
                <div className="hero space-x-4 items-center">
                    <div className="flex-col hero-content justify-center flex items-center overflow-x-auto w-full">
                ...
                <div className="mockup-code flex flex-col space-y-2 max-w-sm mx-auto p-4 m-4">
